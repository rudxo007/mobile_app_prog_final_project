...
public class M6_board extends Activity implements AdapterView.OnItemClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m6_board);
...
// TODO Auto-generated method stub
      ...
      /*  if(memoedit.getText().toString().equals("0")) {*/
        Intent intent = new Intent(this, Data_Storage.class);         //Data_Board
